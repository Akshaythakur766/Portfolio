    ...
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader
          ...
          title="What Cliens Say about Me"
          description="Don`t just take my word for it . See what my clients have to say about my work"
        />
        <div className="mt-12 md:mt-24 flex overflow-x-clip  [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] py-4 -my-4">
